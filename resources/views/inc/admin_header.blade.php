...
<head>
    ...
    <!-- notify js Fremwork -->
    <link rel="stylesheet" type="text/css" href="{{asset('public/backend/libraries\bower_components\pnotify\css\pnotify.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/backend/libraries\bower_components\pnotify\css\pnotify.brighttheme.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/backend/libraries\bower_components\pnotify\css\pnotify.buttons.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/backend/libraries\bower_components\pnotify\css\pnotify.history.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/backend/libraries\bower_components\pnotify\css\pnotify.mobile.css')}}">
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index-1.htm">
                            <img class="img-fluid" src="{{ asset('public/backend/libraries\assets\images\logo.png') }}" alt="Theme-Logo">
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{ asset('public/backend/libraries\assets\images\avatar-4.jpg')}}" class="img-radius" alt="User-Profile-Image">
                                        <span>@if (!Auth::guest()) {{  Auth::user()->name }} @endif </span>
